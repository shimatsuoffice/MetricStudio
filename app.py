...
async def privacy():
    ...
    <p>This application uses Instagram Graph API with minimum scopes to display basic profile and insights data. No personal data is stored on our servers; data is shown only on-screen during your session.</p>
...
async def data_deletion():
    ...
    <p>We do not persist user data. If you want to request deletion of any server-side logs or residuals, please email support@example.com with your Meta User ID. We will confirm and purge within 7 business days.</p>
    """
    return HTMLResponse(html)
